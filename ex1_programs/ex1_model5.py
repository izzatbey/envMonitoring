...
Encoder_model = keras.models.load_model("./model/AE_100", custom_objects={"r_loss": r_loss })
...
class AnchorPositivePairs(keras.utils.Sequence):
    ...
    def __getitem__(self, _idx):
        ...
        x = np.empty((2, num_classes, 32, 32, 64), dtype=np.float32)
...
inputs2 = layers.Input(shape=(32, 32, 64))
...
plt.show()
model2.summary()
model2.save("./model/AE100_CML100")
